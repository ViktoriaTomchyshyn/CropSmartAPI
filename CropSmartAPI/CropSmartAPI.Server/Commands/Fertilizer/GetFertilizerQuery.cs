...
public class GetFertilizerQuery : IRequest<Result<List<FertilizerDto>, string>>
{
    public int CropId { get; set; }

    public class Handler : IRequestHandler<GetFertilizerQuery, Result<List<FertilizerDto>, string>>
    {
        ...
        public async Task<Result<List<FertilizerDto>, string>> Handle(GetFertilizerQuery request,
