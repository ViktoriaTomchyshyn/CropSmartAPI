...
namespace CropSmart_ML
{
    ...
    {
        public const string RetrainConnectionString = @"Data Source=DESKTOP-JJTRH2D;Initial Catalog=CropSmartDB;Integrated Security=True";
        public const string RetrainCommandString = @"SELECT CAST([Id] as REAL), CAST([Name] as NVARCHAR(MAX)), [SowingDate], [HarverstDate], CAST([Fertility] as REAL), CAST([Notes] as NVARCHAR(MAX)), CAST([FieldId] as REAL) FROM [dbo].[Crops]";
